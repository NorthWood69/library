...
class RenewBookInstancesViewTest(TestCase):
    ...
    def test_form_invalid_renewal_date_past(self):
        ...
        self.assertEqual(response.status_code, 200)
        self.assertFormError(response, 'form', 'renewal_date', 'Дата возврата не может быть в прошлом')
    ...
    def test_form_invalid_renewal_date_future(self):
        ...
        self.assertEqual(response.status_code, 200)
        self.assertFormError(response, 'form', 'renewal_date', 'Дата возврата не может быть позднее 4 недель')
...
class AuthorCreateViewTest(TestCase):
    ...
    def setUp(self):
        ...
        test_user1.save()
        test_user2.save()
        permission = Permission.objects.get(name='Add, edit, delete authors')
        test_user2.user_permissions.add(permission)
        test_user2.save()
        # Create a book
        test_author = Author.objects.create(first_name='John', last_name='Smith')
    ...
    def test_form_date_of_death_initially_set_to_expected_date(self):
        ...
        response = self.client.get(reverse('author-create'))
        self.assertEqual(response.status_code, 200)
        expected_initial_date = datetime.date(2090, 10, 25)
